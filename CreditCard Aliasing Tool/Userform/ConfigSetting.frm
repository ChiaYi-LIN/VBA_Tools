...
Private Sub CompanyNameRef_BeforeDragOver(Cancel As Boolean, ByVal Data As MSForms.DataObject, ByVal x As stdole.OLE_XPOS_CONTAINER, ByVal y As stdole.OLE_YPOS_CONTAINER, ByVal DragState As MSForms.fmDragState, Effect As MSForms.fmDropEffect, ByVal Shift As Integer)
...
Private Sub OkButton_Click()
    Dim checkFlagOne, checkFlagTwo, checkFlagThree, checkFlagFour, checkFlagFive, checkFlagSix, checkFlagSeven As Range
        
    'If CompanyNameRef.Text = "" Or LocationNameRef.Text = "" Or GIDRef = "" Or InformationRef.Text = "" Or OIDRef.Text = "" _
    Or LevelHeader = "" Or ParentHeader = "" Then
    ...
    'Else
        ...
        Is Nothing Or checkFlagSix Is Nothing Or checkFlagSeven Is Nothing Then
