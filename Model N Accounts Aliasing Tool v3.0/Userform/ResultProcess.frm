...
Private Sub UserForm_Activate()
    ...
    Call IndicateMasterAndAliased(PUBCompanyName, PUBLocationName, PUBLocationLevel, _
            PUBGIDRef, PUBInformation, PUBOIDRef, PUBLevelHeader, PUBParentHeader, PUBStatusHeader)
End Sub
